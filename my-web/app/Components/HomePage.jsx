  ...
  return (
      <div className='w-full relative h-[100vh] px-10 py-0 flex items-center flex-col md:flex-row overflow-hidden justify-between'>
          <div className='img_spicial flex items-center justify-center'>
              <Image src={'/Hero/men-1.jpg'} width={1000} height={1000} className='img relative top-[60%] md:top-0 h-auto md:h-[100%]' alt='bg-picture' />
          ...
          <div className='img_man flex items-center justify-center'>
            <Image  src={'/Hero/special-4.jpg'} width={1000} height={1000} className='img relative top-[60%] md:top-0 h-auto md:h-[100%]' alt='bg-picture'/>
          ...
          <div className='img_woman flex items-center justify-center'>
            <Image src={'/Hero/women-1.jpg'} width={1000} height={1000} className='img h-auto md:h-[100%]' alt='bg-picture'/>
